 ...
 * @typedef {import('../schema-schema.js').TypeName} TypeName
 * @typedef {import('../schema-schema.js').TypeDefn} TypeDefn
 * @typedef {import('../schema-schema.js').TypeDefnCopy} TypeDefnCopy
 * @typedef {import('../schema-schema.js').TypeDefnLink} TypeDefnLink
 * @typedef {import('../schema-schema.js').TypeDefnString} TypeDefnString
 * @typedef {import('../schema-schema.js').TypeDefnBytes} TypeDefnBytes
 * @typedef {import('../schema-schema.js').TypeDefnStruct} TypeDefnStruct
 * @typedef {import('../schema-schema.js').TypeDefnMap} TypeDefnMap
 * @typedef {import('../schema-schema.js').TypeDefnList} TypeDefnList
 * @typedef {import('../schema-schema.js').TypeDefnUnion} TypeDefnUnion
 * @typedef {import('../schema-schema.js').TypeDefnEnum} TypeDefnEnum
 * @typedef {import('../schema-schema.js').MapRepresentation_StringPairs} MapRepresentation_StringPairs
 * @typedef {import('../schema-schema.js').StructRepresentation_StringPairs} StructRepresentation_StringPairs
 * @typedef {import('../schema-schema.js').UnionRepresentation_StringPrefix} UnionRepresentation_StringPrefix
 * @typedef {import('../schema-schema.js').UnionRepresentation_BytesPrefix} UnionRepresentation_BytesPrefix
 * @typedef {import('../schema-schema.js').UnionMemberInlineDefn} UnionMemberInlineDefn
