...
/**
 * @typedef {import('../schema-schema.js').EnumMember} EnumMember
 * @typedef {import('../schema-schema.js').KindInt} KindInt
 * @typedef {import('../schema-schema.js').KindString} KindString
 * @typedef {import('../schema-schema.js').AnyScalar} AnyScalar
 * @typedef {import('../schema-schema.js').Schema} Schema
 * @typedef {import('../schema-schema.js').TypeDefn} TypeDefn
 * @typedef {import('../schema-schema.js').InlineDefn} InlineDefn
 * @typedef {import('../schema-schema.js').TypeName} TypeName
 * @typedef {import('../schema-schema.js').TypeNameOrInlineDefn} TypeNameOrInlineDefn
