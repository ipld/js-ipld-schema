...
function peg$parse(input, options) {
  ...
  var peg$f3 = function(precomments, annotations, name, definition) {
  ...
  var peg$f27 = function(values) {
    return values
  };
  var peg$f28 = function() { return [] };
  var peg$f29 = function(precomments, annotations, key, options) { return options };
  var peg$f30 = function(precomments, annotations, key, options, type, representationOptions, linecomment) {
  ...
  var peg$f31 = function() { return { optional: true } };
  var peg$f32 = function() { return { nullable: true } };
  var peg$f33 = function() { return { optional: true } };
  var peg$f34 = function() { return { valueNullable: true } };
  var peg$f35 = function(type) { return type };
  var peg$f36 = function(options) {
  return options.reduce(extend, {})
};
  var peg$f37 = function(implicit) { return { implicit } };
  var peg$f38 = function(rename) { return { rename } };
  var peg$f39 = function(implicit) { return implicit };
  var peg$f40 = function(implicit) { return parseInt(implicit, 10) };
  ...
  var peg$f45 = function(representation) {
  return representation
};
  var peg$f46 = function(representation) {
  return representation
};
  var peg$f47 = function(representation) {
  return representation
};
  var peg$f48 = function() { return { keyed: {} } };
  var peg$f49 = function() { return { kinded: {} } };
  var peg$f50 = function() { return { stringprefix: {} } };
  var peg$f51 = function() { return { bytesprefix: {} } };
  var peg$f52 = function(descriptor) { return descriptor };
  var peg$f53 = function(descriptor) { return descriptor };
  var peg$f54 = function(discriminantKey) {
  return { inline: { discriminantKey } }
};
  var peg$f55 = function(discriminantKey, contentKey) {
  return { envelope: { discriminantKey, contentKey } }
};
  var peg$f56 = function() { return { type: 'map' } };
  var peg$f57 = function() { return { type: 'listpairs' } };
  var peg$f58 = function(representation) { return representation };
  var peg$f59 = function(representation) { return representation };
  var peg$f60 = function(options) {
  ...
  var peg$f61 = function(innerDelim) { return { innerDelim } };
  var peg$f62 = function(entryDelim) { return { entryDelim } };
  var peg$f63 = function(representation) { return representation };
  var peg$f64 = function() { return { type: 'map' } };
  var peg$f65 = function(fieldOrder) { return extend({ type: 'tuple' }, fieldOrder ? { fieldOrder } : null) };
  var peg$f66 = function(fields) { return extend({ type: 'stringjoin' }, fields ) };
  var peg$f67 = function(representation) { return representation };
  var peg$f68 = function() { return { type: 'listpairs' } };
  var peg$f69 = function(field, isImplicit, implicitValue) {
  return { [field]: extend({}, isImplicit ? { implicit: coerceValue(implicitValue) } : null) }
};
  var peg$f70 = function(fieldOrder) {
  return fieldOrder
};
  var peg$f71 = function(fieldOrder) {
  return fieldOrder
};
  var peg$f72 = function(fields) {
  ...
  var peg$f73 = function(join) {
  return { join }
};
  var peg$f74 = function(fieldOrder) {
  return { fieldOrder }
};
  var peg$f75 = function() { return { string: {} } };
  var peg$f76 = function() { return { int: {} } };
  var peg$f77 = function(representation) { return { bytes: { representation } } };
  var peg$f78 = function(firstElement, s) { return s };
  var peg$f79 = function(firstElement, subsequentElements) {
  if (!firstElement) {
    return []
  }
  ...
  var peg$f81 = function(first, remainder) { return first + remainder.join('') };
  var peg$f82 = function(chars) { return parseInt(chars.join(''), 10) };
  var peg$f83 = function(name, value) { return value };
  var peg$f84 = function(name, value) {
  return { [name]: value ? value.join('') : '' }
};
  var peg$f85 = function(comments) {
